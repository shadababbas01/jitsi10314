...
import styles2 from '../../../../base/react/components/native/indicatorStyles';
import styles3 from '../../../../../features/filmstrip/components/native/styles';
...
interface IProps {
    ...
    /**
    * An SVG icon to be rendered as the content of the RaiseHandLabel.
    */
    icon?: Function;
...
*/
export default class RaiseHandLabel extends Component<IProps, State> {
    /**
